...
Public feature, dispatcher, configuration, gesture, window-rule, and IPC
reference for Hyprlane on Hyprland 0.56.2. Install and a short starter
config live in the [README](../README.md). See also
[install](install.md), [tutorial](tutorial.md), and
...
`hl.plugin.scroller.dispatch(action, arg?)` as described in the
[README](../README.md).
